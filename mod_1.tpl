...
PROCEDURE_SECTION
  ...
  if(mceval_phase())
    {
    ofstream out("mod_1.mcmc.out",ios::app);
...
FINAL_SECTION
  if(last_phase() && PLATFORM == "Linux")
	{
		adstring cambia = "cp mod_1.rep " + ResultsPath + ".rep";
		system(cambia);
		
		cambia = "cp mod_1.par " + ResultsPath + ".par";
		system(cambia);
		
		cambia = "cp mod_1.std " + ResultsPath + ".std";
		system(cambia);
		
		cambia = "cp mod_1.cor " + ResultsPath + ".cor";
		system(cambia);
		
		cambia = "cp mod_1.mcmc.out " + ResultsPath + ".mcmc.out";
		system(cambia);
	}
