...
FINAL_SECTION
  ...
  {
    adstring cambia = "cp mod_3.rep " + ResultsPath + ".rep";
    system(cambia);
    
    cambia = "cp mod_3.par " + ResultsPath + ".par";
    system(cambia);
    
    cambia = "cp mod_3.std " + ResultsPath + ".std";
    system(cambia);
    
    cambia = "cp mod_3.cor " + ResultsPath + ".cor";
    system(cambia);
    
    cambia = "cp mod_3.mcmc.out " + ResultsPath + ".mcmc.out";
    system(cambia);
  }
