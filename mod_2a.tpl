...
FINAL_SECTION
  ...
  {
    adstring cambia = "cp mod_2a.rep " + ResultsPath + ".rep";
    system(cambia);
    
    cambia = "cp mod_2a.par " + ResultsPath + ".par";
    system(cambia);
    
    cambia = "cp mod_2a.std " + ResultsPath + ".std";
    system(cambia);
    
    cambia = "cp mod_2a.cor " + ResultsPath + ".cor";
    system(cambia);
    
    cambia = "cp mod_2a.mcmc.out " + ResultsPath + ".mcmc.out";
    system(cambia);
  }
